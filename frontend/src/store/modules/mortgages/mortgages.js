...
const mortgagesModule = {
  ...
  state: {
    ...
    BANKS_ALL_DATA: null,
    MORTGAGES_DATA: null,
    MORTGAGES_DATA_COUNT: null,
    MORTGAGES_DATA_NEXT: null,
    MORTGAGES_DATA_PREV: null,
  ...
  getters: {
    ...
    GET_MORTGAGES_DATA_COUNT: state => {
      return state.MORTGAGES_DATA_COUNT;
    },
    GET_MORTGAGES_DATA_NEXT: state => {
      return state.MORTGAGES_DATA_NEXT;
    },
    GET_MORTGAGES_DATA_PREV: state => {
      return state.MORTGAGES_DATA_PREV;
    }
  },
  mutations: {
    ...
    SET_UPDATE_MORTGAGES_DATA_COUNT(state, data) {
      state.MORTGAGES_DATA_COUNT = data;
    },
    destroy_MORTGAGES_DATA(state) {
      state.MORTGAGES_DATA = null;
    },
    SET_UPDATE_MORTGAGES_DATA_NEXT(state, data) {
      state.MORTGAGES_DATA_NEXT = data;
    },
    SET_UPDATE_MORTGAGES_DATA_PREV(state, data) {
      state.MORTGAGES_DATA_PREV = data;
    }
  },
  actions: {
      ...
      return new Promise((resolve, reject) => {
        getAPI
          ...
          .then(response => {
            ...
            context.commit(
              "SET_UPDATE_MORTGAGES_DATA_COUNT",
              response.data.count
            );
            context.commit(
              "SET_UPDATE_MORTGAGES_DATA_NEXT",
              response.data.next
            );
            context.commit(
              "SET_UPDATE_MORTGAGES_DATA_PREV",
